...
const Footer = () => {
  ...
  return (
    <footer className="bg-white pt-24 pb-12 border-t border-slate-100 relative z-10 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-[50%] h-[100%] bg-blue-50/20 blur-[150px] -z-10 rounded-full translate-x-1/3 translate-y-1/2" />
    </footer>
  )
}
